...
export const Terms = () => {
  return (
    <Section className="bg-beige-primary">
      <Container className="mt-[50px] rounded-3xl text-justify">
        <h1 className="text-[45px] font-bold">Terms and Conditions</h1>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Vedant Construction, Pune.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Vedant Construction, accessible
              from{" "}
              <a
                href="https://vedantconstruction.co.in/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://vedantconstruction.co.in/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: contact@vedantconstruction.co.in</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://vedantconstruction.co.in/contact-us"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://vedantconstruction.co.in/contact-us
              </a>
            </p>
          </li>
        </ul>
